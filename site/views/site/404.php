...
<body>
	<div id="wrapper">
		...
		<p class="intro">Erreur 404 - The page you are looking for cannot be found.</p>
		
		<p>The controller that is generating this page is located here:</p>

		<pre><code>APPPATH/classes/controller/site.php</code></pre>

		<p>This view can be located here:</p>
		
		<pre><code>APPPATH/views/site/404.php</code></pre>
