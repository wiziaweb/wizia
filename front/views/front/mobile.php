...
<head>
	...
	<style type="text/css">
		* { margin: 0; padding: 0; }
		body { background-color: #FFCC99; font-family: sans-serif; font-size: 16px; line-height: 20px; margin: 40px; }
		#wrapper { padding: 30px; background: #fff; color: #333; margin: 0 auto; width: 100%; }
		a { color: #36428D; }
...
<body>
	<div id="wrapper">
		<h1>Hello FRONT, <?php echo $name; ?>!</h1>


        <?
        foreach($widgets as $widget)
        {
            echo "<div>".htmlspecialchars_decode($widget['content'])."</div>";
        }
